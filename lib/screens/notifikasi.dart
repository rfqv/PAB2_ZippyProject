...
class _NotifikasiState extends State<Notifikasi> {
  final List<NotifikasiItem> notifications = [
    NotifikasiItem(username: 'Christ', action: 'commented on your ppy: r u ok?', timestamp: '2m ago', profileImage: 'assets/users/favicon/username-itsmechrist-uid-254803.jpg', isFollowing: false),
    ...
    NotifikasiItem(username: 'Nounwoo', action: 'commented on your pypo: Cakeup btl!!', timestamp: '25m ago', profileImage: 'assets/users/favicon/username-leedongwook_official-uid-130743.jpg', isFollowing: true),
    NotifikasiItem(username: 'Nounwoo', action: 'liked your pypo', timestamp: '25m ago', profileImage: 'assets/users/favicon/username-leedongwook_official-uid-130743.jpg', isFollowing: true),
    NotifikasiItem(username: 'Christ', action: 'liked your pypo', timestamp: '26m ago', profileImage: 'assets/users/favicon/username-itsmechrist-uid-254803.jpg', isFollowing: false),
    NotifikasiItem(username: 'Christ', action: 'started following you', timestamp: '26m ago', profileImage: 'assets/users/favicon/username-itsmechrist-uid-254803.jpg', isFollowing: false),
    NotifikasiItem(username: 'Ethan', action: 'started following you', timestamp: '31m ago', profileImage: 'assets/users/favicon/username-ethan1610-uid-256944.jpg', isFollowing: true),
  ];
  @override
